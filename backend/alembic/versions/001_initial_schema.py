"""initial schema with text selection support
...
def upgrade():
    ...
    # Create word_clicks table with new fields for text selection
    op.create_table('word_clicks',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('document_id', sa.Integer(), nullable=False),
        sa.Column('word', sa.String(length=100), nullable=False),
        sa.Column('selected_text', sa.String(length=500), nullable=True),
        sa.Column('user_translation', sa.String(length=1000), nullable=True),
        sa.Column('page_number', sa.Integer(), nullable=True),
        sa.Column('position_in_page', sa.Integer(), nullable=True),
